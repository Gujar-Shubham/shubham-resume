...
`;
class Journal4 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
    ...
    render() {
        ...
        return (
            <>
                ...
                <EuiFlexItem>
                        <EuiSpacer />
                        <EuiText><h2><font face='Segoe UI'>	Concrete compressive strength Prediction using Modified Dimensional Analysis, 
                        Artificial Neural Networks and Machine Learning
                        </font></h2></EuiText>
                        <EuiSpacer size='m' />
                        <EuiText><h5><font face='Segoe UI'>ASCE Journal of Materials in Civil Engineering (Under preparation)
