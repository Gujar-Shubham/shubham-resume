...
`;
class Conference2 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
    ...
    render() {
        ...
        return (
            <>
                ...
                <EuiFlexItem>
                        <EuiSpacer />
                        <EuiText><h2><font face='Segoe UI'>2) Camelot: AI Powered Campaign Management System
                        </font></h2></EuiText>
                        <EuiSpacer size='m' />
                        <EuiText><h5><font face='Segoe UI'>IEEE : GCAT (Global Conference of Advanced Technology) -2021 (Accepted)
                        &emsp; &emsp; &emsp; &emsp; &emsp;
                        &emsp; &emsp; &emsp; &emsp; &emsp; Jan 2021 - June 202</font></h5></EuiText>
                        <EuiSpacer size='m' />
                        <EuiText><b>Research Objectives</b> 
                        <StyledText><ul className="skills-list">
                        {this.state.conference2Research && this.state.conference2Research.map((p, i) => <li key={i}>{p}</li>)}
                        </ul></StyledText>
                        <b>Project Highlights</b>
                        <StyledText><ul className="skills-list">
                        {this.state.conference2Project && this.state.conference2Project.map((p, i) => <li key={i}>{p}</li>)}
                        </ul></StyledText>
                        <b>Value Additions</b>
                        <StyledText><ul className="skills-list">
                        {this.state.conference2Value && this.state.conference2Value.map((p, i) => <li key={i}>{p}</li>)}
                        </ul></StyledText>
                        </EuiText>
                </EuiFlexItem>
                </EuiFlexGroup>
